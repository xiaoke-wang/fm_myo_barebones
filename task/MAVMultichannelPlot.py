...
class MAVMultichannelPlot(object):
    # Plots multidimensional signals in a real-time fashion
    def __init__(self, nchan=16, xlen=512):
        self.nchan = nchan
        self.xlen = xlen
        self.fig = plt.figure(figsize=(10,8))
        self.axes = [self.fig.add_subplot(str(self.nchan/2) , '2' , str(i+1)) for i in range(self.nchan)]
